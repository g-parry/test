...
$layout->blocks["top"][] = "fields";$page_layouts["Leopold_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Leopold_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Leopold_search.htm";
