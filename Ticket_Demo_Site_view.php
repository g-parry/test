...
$layout->blocks["center"][] = "details";$page_layouts["Ticket_Demo_Site_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["Ticket_Demo_Site_view"] = $layout;
}
...
//location - 
	...
	$value="";
	$value=DisplayLookupWizard("location",$data["location"],$data,$keylink,MODE_VIEW, PAGE_VIEW);
...
//make - 
	...
	$value="";
	$value=DisplayLookupWizard("make",$data["make"],$data,$keylink,MODE_VIEW, PAGE_VIEW);
...
//colour - 
	...
	$value="";
	$value=DisplayLookupWizard("colour",$data["colour"],$data,$keylink,MODE_VIEW, PAGE_VIEW);
...
//notes - 
	...
	$value="";
	$value = ProcessLargeText($pageObject->pSet, GetData($data,"notes", "", PAGE_VIEW), "", "", MODE_VIEW);
...
//date - Short Date
	...
	$value="";
	$value = ProcessLargeText($pageObject->pSet, GetData($data,"date", "Short Date", PAGE_VIEW), "", "", MODE_VIEW);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Ticket_Demo_Site_edit.php?".$editlink."'\"");
