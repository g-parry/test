...
$layout->blocks["top"][] = "fields";$page_layouts["Wessex_Homes_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Wessex_Homes_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Wessex_Homes_search.htm";
...
$params['shortTableName'] = 'Wessex_Homes';
