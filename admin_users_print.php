...
//	Name - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "Name", "", PAGE_PRINT),"field=Name".$keylink,"",MODE_PRINT);
			$record["Name_value"] = $value;
			$record["Name_class"] = $pageObject->fieldAlignClass("Name");
//	email - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "email", "", PAGE_PRINT),"field=email".$keylink,"",MODE_PRINT);
			$record["email_value"] = $value;
			$record["email_class"] = $pageObject->fieldAlignClass("email");
//	password - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "password", "", PAGE_PRINT),"field=password".$keylink,"",MODE_PRINT);
