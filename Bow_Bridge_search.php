...
$layout->blocks["top"][] = "fields";$page_layouts["Bow_Bridge_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Bow_Bridge_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Bow_Bridge_search.htm";
...
$params['shortTableName'] = 'Bow_Bridge';
