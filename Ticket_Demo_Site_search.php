...
$layout->blocks["top"][] = "fields";$page_layouts["Ticket_Demo_Site_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Ticket_Demo_Site_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Ticket_Demo_Site_search.htm";
...
$params['shortTableName'] = 'Ticket_Demo_Site';
