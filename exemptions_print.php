...
$layout->blocks["top"][] = "pdf";$page_layouts["exemptions_print"] = $layout;
} else {
$layout = new TLayout("print","FancyPink","MobilePink");
$layout->blocks["center"] = array();
$layout->containers["grid"] = array();
...
//	Location - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "Location", "", PAGE_PRINT),"field=Location".$keylink,"",MODE_PRINT);
...
//	Start Date - Short Date
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "Start Date", "Short Date", PAGE_PRINT),"field=Start+Date".$keylink,"",MODE_PRINT);
			$record["Start_Date_value"] = $value;
			$record["Start_Date_class"] = $pageObject->fieldAlignClass("Start Date");
//	EndDate - Short Date
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "EndDate", "Short Date", PAGE_PRINT),"field=EndDate".$keylink,"",MODE_PRINT);
			$record["EndDate_value"] = $value;
			$record["EndDate_class"] = $pageObject->fieldAlignClass("EndDate");
//	Reason - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "Reason", "", PAGE_PRINT),"field=Reason".$keylink,"",MODE_PRINT);
			$record["Reason_value"] = $value;
			$record["Reason_class"] = $pageObject->fieldAlignClass("Reason");
//	make - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "make", "", PAGE_PRINT),"field=make".$keylink,"",MODE_PRINT);
			$record["make_value"] = $value;
			$record["make_class"] = $pageObject->fieldAlignClass("make");
//	colour - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "colour", "", PAGE_PRINT),"field=colour".$keylink,"",MODE_PRINT);
			$record["colour_value"] = $value;
			$record["colour_class"] = $pageObject->fieldAlignClass("colour");
//	contract - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "contract", "", PAGE_PRINT),"field=contract".$keylink,"",MODE_PRINT);
			$record["contract_value"] = $value;
			$record["contract_class"] = $pageObject->fieldAlignClass("contract");
			if($col<$colsonpage)
...
$xt->assign("EndDate_fieldheadercolumn",true);
$xt->assign("EndDate_fieldheader",true);
$xt->assign("EndDate_fieldcolumn",true);
$xt->assign("EndDate_fieldfootercolumn",true);
$xt->assign("Reason_fieldheadercolumn",true);
$xt->assign("Reason_fieldheader",true);
$xt->assign("Reason_fieldcolumn",true);
$xt->assign("Reason_fieldfootercolumn",true);
...
$xt->assign("contract_fieldheadercolumn",true);
$xt->assign("contract_fieldheader",true);
$xt->assign("contract_fieldcolumn",true);
$xt->assign("contract_fieldfootercolumn",true);
