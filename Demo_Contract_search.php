...
$layout->blocks["top"][] = "fields";$page_layouts["Demo_Contract_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Demo_Contract_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Demo_Contract_search.htm";
...
$params['shortTableName'] = 'Demo_Contract';
