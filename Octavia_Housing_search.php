...
$layout->blocks["top"][] = "fields";$page_layouts["Octavia_Housing_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Octavia_Housing_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Octavia_Housing_search.htm";
...
$params['shortTableName'] = 'Octavia_Housing';
