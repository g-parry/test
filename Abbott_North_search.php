...
$layout->blocks["top"][] = "fields";$page_layouts["Abbott_North_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Abbott_North_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Abbott_North_search.htm";
...
$params['shortTableName'] = 'Abbott_North';
