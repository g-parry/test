...
$layout->blocks["top"][] = "fields";$page_layouts["Glamis_Estate_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Glamis_Estate_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Glamis_Estate_search.htm";
...
$params['shortTableName'] = 'Glamis_Estate';
