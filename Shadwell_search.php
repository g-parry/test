...
$layout->blocks["top"][] = "fields";$page_layouts["Shadwell_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Shadwell_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Shadwell_search.htm";
...
$params['shortTableName'] = 'Shadwell';
