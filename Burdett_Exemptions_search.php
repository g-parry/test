...
$layout->blocks["top"][] = "fields";$page_layouts["Burdett_Exemptions_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Burdett_Exemptions_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Burdett_Exemptions_search.htm";
...
$params['shortTableName'] = 'Burdett_Exemptions';
