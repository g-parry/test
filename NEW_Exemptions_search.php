...
$layout->blocks["top"][] = "fields";$page_layouts["NEW_Exemptions_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["NEW_Exemptions_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "NEW_Exemptions_search.htm";
...
$params['shortTableName'] = 'NEW_Exemptions';
