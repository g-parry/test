...
$layout->blocks["top"][] = "toppanel";$page_layouts["West_London_Mental_Health_list"] = $layout;
} else {
...
$layout->blocks["top"][] = "toplinks";$page_layouts["West_London_Mental_Health_list"] = $layout;
}
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "Location";
						}
