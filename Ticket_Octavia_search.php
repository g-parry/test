...
$layout->blocks["top"][] = "fields";$page_layouts["Ticket_Octavia_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Ticket_Octavia_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Ticket_Octavia_search.htm";
...
$params['shortTableName'] = 'Ticket_Octavia';
