...
$layout->blocks["top"][] = "fields";$page_layouts["ISHA_Exemptions_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["ISHA_Exemptions_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "ISHA_Exemptions_search.htm";
...
$params['shortTableName'] = 'ISHA_Exemptions';
