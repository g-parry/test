...
$layout->blocks["top"][] = "fields";$page_layouts["Spitalfields_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Spitalfields_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Spitalfields_search.htm";
...
$params['shortTableName'] = 'Spitalfields';
