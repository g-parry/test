...
class CrossTableReport
{
	...
	function getstrSQL()
	{
		...
		if($val!=" ")
		{
			...
			if($group_func=="avg") 
				...
				$avg_func=", 1 as avg_sum, 1 as avg_count";
		}
	...
	function ajax_refresh_crosstable()
	{
		...
		echo my_json_encode(array($this->rowinfo,$this->col_summary,$this->total_summary,$this->getRadioGroupFunctions(postvalue("field"),postvalue("group_func")),$this->getTotalsName($this->getGroupFunction($field,postvalue("group_func")))));
	}
