...
$layout->blocks["top"][] = "pdf";$page_layouts["isha_streets_print"] = $layout;
} else {
$layout = new TLayout("print","FancyPink","MobilePink");
$layout->blocks["center"] = array();
$layout->containers["grid"] = array();
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "enfcompany";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("enfcompany");
$fieldsArr[] = $arr;
...
//	ACTIVE - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "ACTIVE", "", PAGE_PRINT),"field=ACTIVE".$keylink,"",MODE_PRINT);
			$record["ACTIVE_value"] = $value;
			$record["ACTIVE_class"] = $pageObject->fieldAlignClass("ACTIVE");
//	contract - 
			$value="";
...
//	enfcompany - 
			$value="";
				$value = ProcessLargeText($pageObject->pSet, GetData($data, "enfcompany", "", PAGE_PRINT),"field=enfcompany".$keylink,"",MODE_PRINT);
			$record["enfcompany_value"] = $value;
			$record["enfcompany_class"] = $pageObject->fieldAlignClass("enfcompany");
			if($col<$colsonpage)
...
$xt->assign("enfcompany_fieldheadercolumn",true);
$xt->assign("enfcompany_fieldheader",true);
$xt->assign("enfcompany_fieldcolumn",true);
$xt->assign("enfcompany_fieldfootercolumn",true);
