...
$layout->blocks["top"][] = "export";$page_layouts["East_End_export"] = $layout;
} else {
$layout = new TLayout("export","FancyPink","MobilePink");
$layout->blocks["top"] = array();
$layout->containers["export"] = array();
...
$xt->display("East_End_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=East_End.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=East_End.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=East_End.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=East_End.csv");
