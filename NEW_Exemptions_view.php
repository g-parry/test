...
$layout->blocks["center"][] = "details";$page_layouts["NEW_Exemptions_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["NEW_Exemptions_view"] = $layout;
}
...
if (!sizeof($data)) {
	header("Location: NEW_Exemptions_list.php?a=return");
	exit();
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='NEW_Exemptions_edit.php?".$editlink."'\"");
