...
$layout->blocks["top"][] = "details";$page_layouts["ISHA_Exemptions_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "ISHA_Exemptions_inline_edit.htm" : "ISHA_Exemptions_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: ISHA_Exemptions_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='ISHA_Exemptions_view.php?".$viewlink."'\"");
