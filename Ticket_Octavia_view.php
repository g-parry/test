...
$layout->blocks["center"][] = "details";$page_layouts["Ticket_Octavia_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["Ticket_Octavia_view"] = $layout;
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Ticket_Octavia_edit.php?".$editlink."'\"");
