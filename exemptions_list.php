...
$layout->blocks["top"][] = "toppanel";$page_layouts["exemptions_list"] = $layout;
} else {
...
$layout->blocks["top"][] = "toplinks";$page_layouts["exemptions_list"] = $layout;
}
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "contract";
								}
