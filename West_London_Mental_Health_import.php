...
if(isMobile()) {
$layout = new TLayout("import","FancyPink","MobilePink");
...
$layout->blocks["top"][] = "import";$page_layouts["West_London_Mental_Health_import"] = $layout;
} else {
$layout = new TLayout("import","FancyPink","MobilePink");
$layout->blocks["top"] = array();
$layout->containers["import"] = array();
...
$xt->display("West_London_Mental_Health_import.htm");
