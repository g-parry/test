...
$layout->blocks["top"][] = "fields";$page_layouts["Brownfield_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Brownfield_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Brownfield_search.htm";
...
$params['shortTableName'] = 'Brownfield';
