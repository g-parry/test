...
if(isMobile()) {
$layout = new TLayout("Mobilelogin","FancyPink","MobilePink");
...
$layout->containers["fields"][] = array("name"=>"loginfields_mobile","block"=>"","substyle"=>1);


$layout->containers["fields"][] = array("name"=>"mesguest","block"=>"guestlink_block","substyle"=>1);


$layout->containers["fields"][] = array("name"=>"mesregforgot","block"=>"","substyle"=>1);
...
$layout = new TLayout("login","FancyPink","MobilePink");
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
