...
$layout->blocks["top"][] = "fields";$page_layouts["Request_Visit_WLMH_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Request_Visit_WLMH_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Request_Visit_WLMH_search.htm";
...
$params['shortTableName'] = 'Request_Visit_WLMH';
