...
$layout->blocks["center"][] = "details";$page_layouts["Request_Visit_WLMH_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["Request_Visit_WLMH_view"] = $layout;
}
...
if (!sizeof($data)) {
	header("Location: Request_Visit_WLMH_list.php?a=return");
	exit();
}
...
if($pageObject->isShowDetailTables && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "Request Visit WLMH";
		$options['firstTime'] = 1;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Request_Visit_WLMH_edit.php?".$editlink."'\"");
