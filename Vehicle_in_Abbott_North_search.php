...
$layout->blocks["top"][] = "fields";$page_layouts["Vehicle_in_Abbott_North_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Vehicle_in_Abbott_North_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Vehicle_in_Abbott_North_search.htm";
...
$params['shortTableName'] = 'Vehicle_in_Abbott_North';
