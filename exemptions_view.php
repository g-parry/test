...
$layout->blocks["center"][] = "details";$page_layouts["exemptions_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["exemptions_view"] = $layout;
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='exemptions_edit.php?".$editlink."'\"");
