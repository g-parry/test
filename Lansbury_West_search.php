...
$layout->blocks["top"][] = "fields";$page_layouts["Lansbury_West_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Lansbury_West_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Lansbury_West_search.htm";
...
$params['shortTableName'] = 'Lansbury_West';
