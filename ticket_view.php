...
$layout->blocks["center"][] = "details";$page_layouts["ticket_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["ticket_view"] = $layout;
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ticket_edit.php?".$editlink."'\"");
