...
$layout->blocks["top"][] = "fields";$page_layouts["Bethnal_Green_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Bethnal_Green_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Bethnal_Green_search.htm";
...
$params['shortTableName'] = 'Bethnal_Green';
