...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"exemptions","varname"=>"exemptions");
	  $this->lstTables[]=array("name"=>"isha_streets","varname"=>"isha_streets");
	  $this->lstTables[]=array("name"=>"ishaugrights","varname"=>"ishaugrights");
	  $this->lstTables[]=array("name"=>"users","varname"=>"users");
	  $this->lstTables[]=array("name"=>"isha_audit","varname"=>"isha_audit");
	  $this->lstTables[]=array("name"=>"ticket","varname"=>"ticket");
	  $this->lstTables[]=array("name"=>"make","varname"=>"make");
	  $this->lstTables[]=array("name"=>"colour","varname"=>"colour");
	  $this->lstTables[]=array("name"=>"dispensations_locking","varname"=>"dispensations_locking");
	  $this->lstTables[]=array("name"=>"ishauggroups","varname"=>"ishauggroups");
	  $this->lstTables[]=array("name"=>"ishaugmembers","varname"=>"ishaugmembers");
	}
