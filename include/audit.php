...
class AuditTrailTable
{
	...
	{
		if($table=="ISHA Exemptions")
		{
			return true;
		}
		if($table=="NEW Exemptions")
		{
			return true;
		}
		if($table=="Burdett Exemptions")
		{
			return true;
		}
		if($table=="Abbott North")
		{
			return true;
		}
		if($table=="Bethnal Green")
		{
			return true;
		}
		if($table=="Bow Bridge")
		...
		if($table=="Glamis Estate")
		{
			return true;
		}
		if($table=="Island Homes")
		{
			return true;
		}
		if($table=="Lansbury")
		...
		if($table=="Wessex Homes")
		{
			return true;
		}
		if($table=="Octavia Housing")
		{
			return true;
		}
		if($table=="West London Mental Health")
		{
			return true;
		}
		if($table=="Abbott South")
		{
			return true;
		}
		if($table=="isha_streets")
		{
			return true;
		}
		if($table=="Demo Contract")
		{
			return true;
		}
		if($table=="Devons")
		...
		if($table=="Vehicle in Abbott North")
		{
			return true;
		}
		if($table=="Ticket Octavia")
		{
			return true;
		}
		if($table=="Ticket Demo Site")
		{
			return true;
		}
		if($table=="elite")
