...
js.setAttribute('src',"http://webplayer.yahooapis.com/player.js");document.getElementsByTagName('HEAD')[0].appendChild(js);}
...
this.loaded=function(){YAHOO.mediaplayer.Parser.prototype.checkForLocalHost=function(url){return false;};self.isLoaded=true;}}
