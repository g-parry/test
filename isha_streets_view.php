...
$layout->blocks["center"][] = "details";$page_layouts["isha_streets_view"] = $layout;
} else {
...
$layout->skins["details"] = "empty";
$layout->blocks["top"][] = "details";$page_layouts["isha_streets_view"] = $layout;
}
...
//ACTIVE - 
	...
	$value="";
	$value = ProcessLargeText($pageObject->pSet, GetData($data,"ACTIVE", "", PAGE_VIEW), "", "", MODE_VIEW);
...
//enfcompany - 
	...
	$value="";
	$value = ProcessLargeText($pageObject->pSet, GetData($data,"enfcompany", "", PAGE_VIEW), "", "", MODE_VIEW);
	if($mainTableOwnerID=="enfcompany")
		$ownerIdValue=$value;
	$xt->assign("enfcompany_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='isha_streets_edit.php?".$editlink."'\"");
