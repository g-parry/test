...
$layout->blocks["top"][] = "fields";$page_layouts["East_End_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["East_End_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "East_End_search.htm";
...
$params['shortTableName'] = 'East_End';
