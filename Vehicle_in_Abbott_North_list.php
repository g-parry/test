...
$layout->blocks["top"][] = "toppanel";$page_layouts["Vehicle_in_Abbott_North_list"] = $layout;
} else {
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Vehicle_in_Abbott_North_list"] = $layout;
}
