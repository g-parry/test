...
$layout->blocks["top"][] = "fields";$page_layouts["Lansbury_search"] = $layout;
} else {
...
$layout->blocks["top"][] = "search";$page_layouts["Lansbury_search"] = $layout;
}
...
$mode = SEARCH_SIMPLE;
$templatefile = "Lansbury_search.htm";
...
$params['shortTableName'] = 'Lansbury';
